...
class CRM_Triggers_BAO_ActionRule extends CRM_Triggers_DAO_ActionRule {
   ...
   */
  public function processEntity(CRM_Core_DAO $objRef, CRM_Triggers_BAO_TriggerRule $trigger_rule, CRM_Triggers_BAO_RuleSchedule $rule_schedule) {
    ...
    CRM_Triggers_BAO_ProcessedTrigger::processTrigger($objRef, $trigger_rule, $rule_schedule, $this, $contacts);
